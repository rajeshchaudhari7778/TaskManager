...
pipeline {
    ...
    parameters {
        ...
        booleanParam(name: 'RUN_TESTS', defaultValue: true, description: 'Set to true to run the test stage')
        booleanParam(name: 'CLEAN_WORKSPACE', defaultValue: false, description: 'Set to true to clean the workspace before starting')
    }
    stages {
        stage('Clean Workspace') {
            when {
                expression { params.CLEAN_WORKSPACE.toBoolean() }
            }
            steps {
